...
public class ElectromagneticCoil extends Artefacts {
    public ElectromagneticCoil() {
        ...
        power = "Ускоряет скорость стрельбы за каждое убийство на 5% до 100% и добавляет электрический урон " + "(электрический урон станит противника на 2 секунды с 30% шансом)";
        speedUP = 100;
